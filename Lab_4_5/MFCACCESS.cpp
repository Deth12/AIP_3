...
// MFCACCESS.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCACCESSApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCACCESSApp

CMFCACCESSApp::CMFCACCESSApp()
{
...
// Единственный объект CMFCACCESSApp

CMFCACCESSApp theApp;


// Инициализация CMFCACCESSApp

BOOL CMFCACCESSApp::InitInstance()
{
